...
class case_existing_file(base_case):
	...
	def act(self, handler):
		self.handle_file(handler, hander.full_path)

class casedirectory_index_file(base_case):
	def test(self, handler):
...
class RequestHandler(BaseHTTPServer.BaseHTTPHandler):
